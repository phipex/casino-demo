...
/**
 * Criteria class for the {@link co.com.ies.pruebas.domain.Model} entity. This class is used
 * in {@link co.com.ies.pruebas.web.rest.ModelResource} to receive all the possible filtering options from
...
public class ModelCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, manufacturerId, distinct);
    }
