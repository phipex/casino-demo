...
export const OperatorDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/operator' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoCasinoApp.operator.delete.question">¿Seguro que quiere eliminar Operator {operatorEntity.id}?</ModalBody>
      <ModalFooter>
