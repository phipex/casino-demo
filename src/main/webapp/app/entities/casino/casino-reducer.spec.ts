...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './casino.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASINO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CASINO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CASINO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CASINO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CASINO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CASINO actions', async () => {
      const arg = 42666;
