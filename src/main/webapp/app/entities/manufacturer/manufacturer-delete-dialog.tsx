...
export const ManufacturerDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/manufacturer' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoCasinoApp.manufacturer.delete.question">
        ¿Seguro que quiere eliminar Manufacturer {manufacturerEntity.id}?
      </ModalBody>
      <ModalFooter>
