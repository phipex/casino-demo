...
export const Manufacturer = () => {
  ...
  const totalItems = useAppSelector(state => state.manufacturer.totalItems);
    ...
    <div>
      ...
      <div className="table-responsive">
        {manufacturerList && manufacturerList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/manufacturer/${manufacturer.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/manufacturer/${manufacturer.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">Ningún Manufacturers encontrado</div>
        )}
      </div>
      {totalItems ? (
